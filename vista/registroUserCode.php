...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["tipos"])&&isset($_POST["clipro"])&&isset($_POST["nom"]) && isset($_POST["ape"])&& isset($_POST["cor"]) && isset($_POST["region"]) && isset($_POST["provincia"]) && isset($_POST["distrito"]) && isset($_POST["dni"]) && isset($_POST["cel"])&& isset($_POST["contra"])) {
      ...
      $txtcontra    = validar_campo($_POST["contra"]);
        ...
        $txtdepa   = validar_campo($_POST["region"]);
