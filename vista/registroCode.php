...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["usuario"])&&isset($_POST["nom"]) && isset($_POST["ape"])&& isset($_POST["cor"]) && isset($_POST["lista_reproduccion"]) && isset($_POST["videos"]) && isset($_POST["dis"]) && isset($_POST["dni"]) && isset($_POST["cel"])&& isset($_POST["contra"])) {
        ...
        $txtdepar     = validar_campo($_POST["lista_reproduccion"]);
