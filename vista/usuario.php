		...
		<div class="full-box dashboard-sideBar-ct">
			...
			<!-- SideBar User info -->
				...
				<figure class="full-box">
					...
					<figcaption class="text-center text-titles"> <?php echo $_SESSION["correo"]["nomcli"]; ?></figcaption>
				</figure>
			...
			<ul class="list-unstyled full-box dashboard-sideBar-Menu">
				...
				<li>
					<a href="#!" class="btn-sideBar-SubMenu">
						<i class="zmdi zmdi-case zmdi-hc-fw"></i> Usuario <i class="zmdi zmdi-caret-down pull-right"></i>
					</a>
